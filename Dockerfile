...
ENV CRAWL_NAV_TIMEOUT=10000
ENV ANALYSIS_NAV_TIMEOUT=15000
ENV PDF_PAGE_RECYCLE=75
ENV SAFE_PATH_SEGMENT_MAX=48
ENV SAFE_REL_PATH_MAX=150
ENV SSE_HEARTBEAT_SECONDS=20
EXPOSE 5000
CMD exec gunicorn -k gthread -w 1 --threads 8 --timeout 0 -b 0.0.0.0:${PORT} app:app --access-logfile - --error-logfile - --capture-output
